<div x-data="{ isOpen: false }">
    ...
    <div x-cloak x-show="isOpen" x-transition:enter="transition ease-out duration-300"
        ...
        x-transition:leave-end="opacity-0 transform translate-x-8" @keydown.escape.window="isOpen = false" x-init="
        ...
        <div class="flex items-center">
            ...
            <div class="ml-2 text-sm font-semibold text-gray-500 sm:text-base">Idea was updated successfully!</div>
        </div>
