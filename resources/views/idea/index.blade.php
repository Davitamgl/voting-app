<x-app-layout>
    <div class="flex flex-col space-y-3 md:space-x-6 filters md:flex-row md:space-y-0">
                    ...
                    <div class="flex flex-col justify-between w-full mx-2 md:mx-4">
                        ...
                        <div class="flex flex-col justify-between mt-6 md:items-center md:flex-row">
                            ...
                            <div x-data="{ isOpen: false }" class="flex items-center mt-4 space-x-2 md:mt-0">
                                <div
                                    class="right-0 z-10 px-4 py-2 font-bold leading-none text-center uppercase bg-gray-200 rounded-full text-xxs w-28 h-7 md:ml-8 top-8 md:top-6 md:left-0">
                                    Open</div>
