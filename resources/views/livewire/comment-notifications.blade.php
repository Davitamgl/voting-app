<div x-data="{ isOpen: false }" class="relative">
    ...
    <ul class="absolute z-10 overflow-y-auto text-sm text-left text-gray-700 bg-white w-76 md:w-76 shadow-dialog rounded-xl max-h-128 -right-28 md:-right-12"
        ...
        @if ($notifications->isNotEmpty() && !$isLoading)
            @foreach ($notifications as $notification)
                ...
                " --}}
                        ...
                        <div class="ml-4">
                            ...
                            <div class="mt-2 text-xs text-gray-500">{{ $notification->created_at->diffForHumans() }}
                            </div>
                        </div>
                    </a>
                </li>
            ...
            <li class="text-center border-t border-gray-300">
                <button class="block w-full px-5 py-4 font-semibold transition duration-150 ease-in hover:bg-gray-100">
                    Mark all as read
                </button>
            </li>
        @elseif ($isLoading)
