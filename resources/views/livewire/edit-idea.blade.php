<div x-cloak x-data="{ isOpen: false }" x-show="isOpen" @keydown.escape.window="isOpen = false"
    @custom-show-edit-modal.window="isOpen = true" x-init="
    ...
    <div class="flex items-end justify-center min-h-screen">
        <div x-show.transition.opacity="isOpen" class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75"
            aria-hidden="true">
        </div>
        ...
        <div x-show.transition.origin.bottom.duration.300ms="isOpen"
            ...
            <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                ...
                <p class="px-6 mt-4 text-xs leading-5 text-center text-gray-500">You have one hour to edit your idea from
